  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-svh">
      ...
      <button
        ...
        className="flex items-center gap-2 px-6 py-3 text-gray-100 transition-colors bg-gray-900 rounded-lg shadow-md hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-300"
      >
